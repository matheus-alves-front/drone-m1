...
### `docs/reference/INITIAL-CODEX-PROMPT.md`
...
### `docs/reference/SUBAGENT-PROMPTS.md`
...
### `docs/reference/PHASE-OWNERSHIP-MATRIX.md`
...
1. abrir `docs/reference/INITIAL-CODEX-PROMPT.md`
2. colar no Codex
